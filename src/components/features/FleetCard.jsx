...
const FleetCard = ({ vehicle }) => {
    const { name, image, category, passengers, luggage, transmission, fuel, price, withDriver } = vehicle;
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                    <div>
                        ...
                        <div className="text-lg font-bold text-primary-DEFAULT">
                            {price ? (
                                <>{price.toLocaleString('ru-RU')} ₽ <span className="text-sm font-normal text-gray-500">/ day</span></>
                            ) : (
